...
|---|---|---|
| 0.001 ETH | `xns`, `trb`, `auditor`, `diamond`, `facet`, `x2x`, `123`, `8pm`, `acc`, `alt`, `fam`, `frog`, `goat`, `idgaf`, `off`, `rulez`, `ship`, `tab`, `whatever`, `dca`, `314159`, `a-lot`, `agree`, `always-winning`, `apr`, `aug`, `black`, `book`, `broke-bro`, `cloud`, `commit`, `crops`, `dec`, `dream`, `earth`, `elite`, `ether`, `feb`, `game-over`, `green`, `green-candle-lover`, `green-only`, `harmony`, `hello`, `hyper`, `i-dont`, `i-think`, `indeed`, `jan`, `jul`, `jun`, `layer`, `level`, `looking-for-a-job`, `mar`, `may`, `maybe`, `nature`, `no-idea`, `no-problem`, `no-war`, `north`, `nov`, `oct`, `on-it`, `online`, `orange`, `other`, `panda`, `platin`, `pre-rich`, `purple`, `rails`, `rainbow`, `reset`, `scout`, `sep`, `silver`, `smoke`, `snake`, `south`, `spend`, `stack-too-deep`, `the-end`, `white`, `why-not`, `wolve`, `yellow`, `zation`, `1-cent`, `abi`, `action`, `allez`, `bin`, `bird`, `bonk`, `boom`, `brave`, `buy-the-dip`, `cafe`, `carpe-diem`, `carrot`, `chain`, `cheese`, `crispy`, `cold`, `cooking`, `cozy`, `dance`, `done`, `dude`, `emoji`, `fire`, `get-it-done`, `goal`, `group`, `guardian`, `haha`, `honey`, `hooligan`, `i-am`, `i-am-not`, `idk`, `jpg`, `kek`, `leverage`, `liquidated`, `lion`, `mate`, `matrix`, `milk`, `mint`, `offside`, `otc`, `ouais`, `p2p`, `peanut`, `play`, `png`, `poc`, `race`, `refill`, `rgb`, `road`, `smile`, `snow`, `stack`, `status`, `style`, `svg`, `synth`, `this-is-fine`, `transfer`, `trust-me-bro`, `victim`, `virus`, `we-are-so-back` | bob.xns, my-oracle.trb, best.auditor |
| 0.002 ETH | `give`, `impact`, `gm`, `me`, `dev`, `emu`, `omg`, `tn`, `dj`, `eco`, `gn`, `inx`, `md`, `mr`, `mrs`, `ngo`, `50c`, `not`, `or`, `org`, `px`, `rx`, `yes`, `joy`, `app`, `trader`, `wallet`, `0-9`, `afro`, `asap`, `atom`, `aux`, `bell`, `bid`, `blue`, `bug`, `bum`, `co2`, `crew`, `day`, `desk`, `dirt`, `drop`, `east`, `edit`, `else`, `era`, `fan`, `farm`, `ffs`, `flex`, `flow`, `fte`, `ftw`, `gem`, `glad`, `go-up`, `hey`, `how`, `jump`, `lean`, `mini`, `mono`, `nail`, `only`, `open`, `own`, `path`, `pen`, `pink`, `pool`, `pop`, `red`, `run`, `sea`, `sov`, `stop`, `sub`, `tbh`, `team`, `this`, `time`, `tion`, `volt`, `way`, `west`, `xau`, `xgr`, `xlsx`, `yet`, `z12`, `zeus`, `zone`, `24h`, `af`, `beast`, `chef`, `chip`, `chick`, `crash`, `day0`, `dnd`, `frens`, `fud`, `gang`, `hill`, `icon`, `mf`, `pain`, `rebel`, `renegade`, `retro`, `so-what`, `the`, `twin` | max.gm, its.me, front.dev |
| 0.003 ETH | `diva`, `mana`, `xly`, `intern`, `donate`, `01`, `3d`, `4d`, `ash`, `bold`, `bruh`, `cake`, `cubic`, `dot`, `fly`, `guy`, `her`, `him`, `max`, `ten`, `ok`, `abc`, `air`, `car`, `cat`, `dog`, `hex`, `llm`, `wen`, `win`, `zap`, `www`, `00s`, `247`, `80s`, `90s`, `billy`, `bunny`, `don`, `dpm`, `exo`, `gum`, `mir`, `nemo`, `payme`, `rollin` | miss.diva, give.mana, exact.xly |
| 0.004 ETH | `wagmi`, `ngmi`, `uno`, `nfa`, `agi`, `aura`, `dyor`, `flip`, `hub`, `hype`, `iron`, `mobi`, `vibe`, `wild`, `99pct`, `100k`, `1st`, `21m`, `365`, `a-z`, `kong`, `ngl`, `all-in`, `drift`, `joker`, `orange21`, `pct`, `pico`, `qbit`, `wow` | bob.wagmi, we.ngmi, numero.uno |
| 0.005 ETH | `yolo`, `buidl`, `algo`, `ser`, `retard`, `arb`, `club`, `cow`, `crown`, `crypto`, `fame`, `guru`, `jewel`, `love`, `safe`, `ultra`, `babe`, `snap`, `swap`, `9-5`, `acx`, `bay`, `crv`, `null`, `nyc`, `permabull`, `polar`, `tokyo` | alice.yolo, jack.buidl, gm.ser |
| 0.006 ETH | `bot`, `mod`, `geo`, `ice`, `bag`, `4real`, `aero`, `ath`, `beatz`, `dice`, `ninja`, `super` | wallee.bot |
| 0.007 ETH | `chad`, `rekt`, `007`, `royal`, `iq200`, `titan`, `shark`, `fbi`, `sky`, `eip-000` | crypto.chad, get.rekt |
| 0.008 ETH | `og`, `ape`, `long`, `short`, `bet`, `lol`, `anon`, `zero`, `1x`, `yq`, `daddy`, `hash`, `neo`, `octo`, `yzi` | punk.og, 100x.ape, based.anon |
| 0.009 ETH | `gwei`, `slot-0` | give-me.gwei |
| 0.010 ETH | `gu`, `token`, `coin`, `web3`, `erc`, `erc20`, `cc`, `game`, `boss`, `one`, `mc`, `tx`, `gp`, `amb`, `ws`, `us`, `new`, `bq`, `bd`, `dat`, `dna`, `bit`, `sha256`, `down-99pct`, `down-only`, `up-only`, `be`, `go`, `it`, `on`, `up`, `ch`, `ct`, `ec`, `ez`, `o2`, `pi`, `zk`, `giga`, `a2a`, `down-bad`, `hot`, `os`, `what` | uni.token, pepe.coin, end.game |
| 0.011 ETH | `code` | write.code |
| 0.012 ETH | `agent`, `pro`, `xtra` | clawd.agent |
| 0.013 ETH | `quant` | - |
| 0.015 ETH | `bull`, `ai`, `id`, `meme`, `pepe`, `vault`, `degen`, `gg`, `clan`, `rocks`, `kol`, `perp`, `cool`, `vega`, `dope`, `dex`, `yoda`, `lambo`, `halo`, `rex`, `prince`, `princess`, `szn`, `rocket`, `o8` | cyber.bull, dank.meme, defi.vault |
